...
export function LifeDashboard({ tasks, projects, notes, events, workspaceName, onComplete, onOpenTask, onOpenProject, onOpenNote, onOpenTasks, onOpenProjects, onOpenNotes, onNewTask, onNewProject, onNewNote, onOpenCalendar, onOpenNow, enableMasterOS = true, onOpenMasterOS }: {
  ...
  return <div className="os-dashboard life-dashboard">
    ...
    <div className="os-quick-row"><QuickAction icon={NotebookPen} label="New note" onClick={onNewNote} /><QuickAction icon={ListTodo} label="New task" onClick={onNewTask} /><QuickAction icon={FolderKanban} label="New project" onClick={onNewProject} />{enableMasterOS && <QuickAction icon={GraduationCap} label="MasterOS" onClick={() => onOpenMasterOS?.()} />}</div>
...
export type { SchoolView, QuickCapturePayload, SchoolCalendarPayload } from "@/app/components/SchoolPlanner";
export { SchoolDashboard } from "@/app/components/SchoolPlanner";
