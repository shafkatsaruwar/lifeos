  ...
  return (
    <div className="app-shell">
      ...
      <AnimatePresence>
        ...
        {actionProjectName && projectItems.find(project => project.name === actionProjectName) && <ProjectActionsModal key={`project-actions-${actionProjectName}`} project={projectItems.find(project => project.name === actionProjectName)!} close={() => setActionProjectName(null)} setKind={(kind) => updateProjectKind(actionProjectName, kind)} onDelete={() => deleteProject(actionProjectName)} />}
...
function ProjectActionsModal({ project, close, setKind, onDelete }: { project: Project; close: () => void; setKind: (kind: ProjectKind) => void; onDelete?: () => void }) {
