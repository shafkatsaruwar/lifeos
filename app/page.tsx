...
function CalendarEventModal({ close, add, event, remove, defaultDate }: { close: () => void; add: (event: CalendarEvent) => void; event?: CalendarEvent; remove?: (id: string) => void; defaultDate?: string }) {
  const now = new Date();
