...
import { UniversityModal, ProgramModal, DocumentModal, StudyAbroadCollectionView } from "@/app/components/StudyAbroadModals";
...
export default function LifeOS() {
  ...
  const [studyAbroadModal, setStudyAbroadModal] = useState<"university" | "program" | "document" | null>(null);
