...
/** Strip HTML and collapse whitespace from note bodies. */
...
/** Pull bullet/line items from a meeting note's ACTION ITEMS section. */
...
/** Build one or more task payloads from a note (meeting notes can fan out to multiple tasks). */
